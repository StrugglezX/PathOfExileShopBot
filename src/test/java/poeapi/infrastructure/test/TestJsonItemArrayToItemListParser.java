...
public class TestJsonItemArrayToItemListParser {
	...
	private List<PathOfExileItem> expectedItems(){
		...
		List<String> sockets0 = new ArrayList<String>();
		String name0 = "";
		...
		List<String> sockets1 = new ArrayList<String>();
		sockets1.add(new String("I"));
		...
		List<String> sockets2 = new ArrayList<String>();
		String name2 = "";
		...
		List<String> sockets3 = new ArrayList<String>();
		String name3 = "";
		...
		List<String> sockets4 = new ArrayList<String>();
		String name4 = "";
		...
		List<String> sockets5 = new ArrayList<String>();
		...
		List<String> sockets6 = new ArrayList<String>();
		sockets6.add(new String("I"));
		sockets6.add(new String("I"));
		...
		List<String> sockets7 = new ArrayList<String>();
		String name7 = "";
		...
		List<String> sockets8 = new ArrayList<String>();
		String name8 = "";
		...
		List<String> sockets9 = new ArrayList<String>();
		sockets9.add(new String("S"));
		sockets9.add(new String("I"));
		sockets9.add(new String("I"));
		...
		List<String> sockets10 = new ArrayList<String>();
		String name10 = "";
		...
		List<String> sockets11 = new ArrayList<String>();
		String name11 = "";
		...
		List<String> sockets12 = new ArrayList<String>();
		String name12 = "";
		...
		List<String> sockets13 = new ArrayList<String>();
		...
		List<String> sockets14 = new ArrayList<String>();
		sockets14.add(new String("I"));
		sockets14.add(new String("I"));
		sockets14.add(new String("S"));
		sockets14.add(new String("S"));
		...
		List<String> sockets15 = new ArrayList<String>();
		String name15 = "";
		...
		List<String> sockets16 = new ArrayList<String>();
		String name16 = "";
		...
		List<String> sockets17 = new ArrayList<String>();
		String name17 = "";
		...
		List<String> sockets18 = new ArrayList<String>();
		String name18 = "";
