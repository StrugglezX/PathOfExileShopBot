...
public class PathOfExileItem {
	...
	public PathOfExileItem(int width, int height, int itemLevel, String icon, boolean sixLink, String name,
			String typeLine, boolean corrupted, boolean identified, List<String> implicitMods,
			List<String> explicitMods, int xLocation, int yLocation, List<PathOfExileItem> socketedItems) {
		super();
		_width = width;
		_height = height;
	...
	public boolean isSixLink() {
		return _sixLink;
	}
	public void setSixLink(boolean sixLink) {
		_sixLink = sixLink;
	}
	...
	public String debugToString(String parentListVariable){
		...
		constructionString.append(String.format("boolean sixLink%d = %b;\n", count, isSixLink()));
	...
	public String toString() {
		return "PathOfExileItem [_width=" + _width + ", _height=" + _height + ", _itemLevel=" + _itemLevel + ", _icon="
				+ _icon + ", _sixLink=" + _sixLink + ", _name=" + _name + ", _typeLine=" + _typeLine + ", _corrupted="
				+ _corrupted + ", _identified=" + _identified + ", _implicitMods=" + _implicitMods + ", _explicitMods="
				+ _explicitMods + ", _xLocation=" + _xLocation + ", _yLocation=" + _yLocation + ", _socketedItems="
				+ _socketedItems + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + (_sixLink ? 1231 : 1237);
